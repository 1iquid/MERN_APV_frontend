          ...
          <div className="w-full md:w-1/2 bg-white shadow rounded-lg p-5">
            ...
            <form onSubmit={handleSubmit}>
              <div className='my-3'>
                ...
                <input type="password" onChange={e => setPassword({...password, [e.target.name] : e.target.value})} name='pwd_actual' className='border bg-gray-50 w-full p-2 mt-5 rounded-lg' placeholder='Escribe tu password actual' />
              </div>
              <div className='my-3'>
                <label className='uppercase font-bold text-gray-600'>Password Nuevo</label>
                <input type="password" onChange={e => setPassword({...password, [e.target.name] : e.target.value})} name='pwd_nuevo' className='border bg-gray-50 w-full p-2 mt-5 rounded-lg' placeholder='Escribe un nuevo password' />
              </div>
